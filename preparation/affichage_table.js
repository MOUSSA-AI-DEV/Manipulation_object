...
let body = document.getElementById("employees-tbody")

// console.log(employees)

let btn = document.getElementById("btn-swich")
...
btn.addEventListener("click",(e)=>{
    ...
    employees.forEach(el => { 
        ...
        let poste = document.createElement("td")
        let salaire = document.createElement("td")
        tdnom.textContent=el.firstName
        prenom.textContent=el.lastName
        department.textContent=el.department
        poste.textContent=el.position
        salaire.textContent=el.salary
